...
public class SnakeGameV2 extends Applet implements Runnable, KeyListener{
	...
	public void paint(Graphics g) {
		...
		if (!gameOver) {
			...
			gfx.drawString("Size: " + snake.getSize(), 80, 415);
		}
			...
			gfx.drawString("Size: " + snake.getSize(), 165, 200);
	...
	public void checkGameOver() {
		if (snake.getX() < 0 || snake.getX() > 394)
			gameOver = true;
		if (snake.getY() < 0 || snake.getY() > 394)
			gameOver = true;
